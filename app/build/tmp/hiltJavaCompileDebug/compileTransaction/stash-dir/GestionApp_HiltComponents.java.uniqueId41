...
import com.gestion.itinerario.di.DatabaseModule;
...
import com.gestion.itinerario.workers.AppointmentReminderWorker_HiltModule;
import com.gestion.itinerario.workers.MaintenanceReminderWorker_HiltModule;
import dagger.Binds;
...
public final class GestionApp_HiltComponents {
  private GestionApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          MaintenanceReminderWorker_HiltModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements GestionApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          ServiceViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          ...
          ServiceViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
